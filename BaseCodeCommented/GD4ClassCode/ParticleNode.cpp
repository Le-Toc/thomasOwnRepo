...
#include <algorithm>
//Particle nodes, study in depth if we're doing particles in game
...
{}
//add particle at position, color from table, particle lifespan from table add particle to vector?
...
void ParticleNode::updateCurrent(sf::Time dt, CommandQueue&)
{
	...
	//foreach particle in particle vector, decrease lifetime
...
//think this is how we determine particle position  and color decay??
