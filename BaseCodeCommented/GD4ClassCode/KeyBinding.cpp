...
//user action key bindings; need to spend more time or look up class docs to understand this 
...
//this looks like it determines whether there is a user action call using a switch to determine which action
